...
<p align="center">
  ...
  <img src="[https://upload.wikimedia.org/wikipedia/commons/e/e0/.NET_Logo.svg](https://pt.wikipedia.org/wiki/Ficheiro:Microsoft_.NET_logo.svg)" width="40" height="40"/>
...
### 🗒️ School Management System – Colégio João Paulo I *(C# + MySQL)*  
- 🔑 Authentication with access levels  
- 📊 Score registration and management  
- 📑 Automated reports with intuitive interface  

### 🗒️ Academic Management System – Ingrid Soutinho Studio de Dança *(C# + MySQL)*  
- 👨‍🎓 Student, class, and modality registration  
- 💰 Enrollment and tuition control  
...
### 🌐 Personal Portfolio *(React.js + Vite + EmailJS)*  
- 📬 Functional contact form integrated with EmailJS  
- 🎨 Modern dark theme with animations  
- 🛠️ Responsive design showcasing tech stack and projects  
